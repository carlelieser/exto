	...
	for await (const link of links) {
		...
		try {
			...
			try {
				...
				console.error(`Validation failed for ${href}:`, err instanceof Error ? err.message : err);
			}
		} catch (err) {
...
export const getEpisodeLinks = async (id: string, res: string, season: number, episode: number, labelFilter?: string, limit?: number, headless?: boolean) => {
